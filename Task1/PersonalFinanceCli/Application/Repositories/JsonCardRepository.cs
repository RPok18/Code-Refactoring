...
public sealed class JsonCardRepository : JsonRepositoryloadsave, ICardRepository
{
    ...
    public Card? GetDefaultBydataStorefileData()
    {
    ...
    public Card Add(Card card)
    {
        ...
        {
            card.Id = RepositoryIdGenerator.NextId(
                fileData.Cards,
                c => c.Id);
